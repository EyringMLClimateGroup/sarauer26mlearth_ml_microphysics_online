...
- [preprocessing](preprocessing): contains the data preprocessing pipeline, including scripts for vertical coarse-graining (`vertical_coarse.py`) and combined data preprocessing (`preprocess_combined.py`), along with grid files (`vgrid.nc`, `vgrid_regridded.nc`) and output distribution histograms (`data_histos/`).
